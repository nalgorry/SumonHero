var cControlCards = (function () {
    ...
    cControlCards.prototype.initCards = function () {
        ...
        this.arrayCards.push(this.createNewCard(20, 500, 1 /* blue */));
        this.arrayCards.push(this.createNewCard(100, 500, 2 /* red */));
        this.arrayCards.push(this.createNewCard(180, 500, 3 /* green */));
    };
